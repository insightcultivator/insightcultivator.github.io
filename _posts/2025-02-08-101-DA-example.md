...
#### **3. 제품 카테고리별 매출 (堆积된 바 차트 또는 도넛 차트)**
...
<!-- 생성한 html 보여주기 -->
<iframe 
  src="{{ site.url }}{{ site.baseurl }}/assets/sales_dashboard.html" 
  width="100%" 
  height="800px" 
  frameborder="0"
  allowfullscreen>
